                        ...
                        <form method="post" action="{{ route('create-form') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-textarea-input id="description" name="description" type="text" class="mt-1 block w-full"
                                    required autofocus autocomplete="description" >{{ old('description', $form->description) }}</x-textarea-input>
                            ...
                            <div>
                                ...
                                <x-text-input id="table_name" name="table_name" type="text" class="mt-1 block w-full"
                                    :value="old('table_name', $form->table_name)" autocomplete="table_name" placeholder="jika tidak diisi maka nama table random"/>
                            ...
                            <div>
                                ...
                                <x-text-input id="slug" name="slug" type="text" class="mt-1 block w-full"
                                    :value="old('slug', $form->slug)" autocomplete="slug" placeholder="jika tidak diisi maka slug akan berupa uuid" />
