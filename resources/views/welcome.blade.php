        ...
        <div class="relative pt-24 lg:pt-28">
            <div class="mx-auto px-6 max-w-7xl md:px-12">
                <div class="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                    ...
                    <img src="{{ asset('assets/images/sigra-logo.png')}}" alt="icon pendataan app" width="225" class="mx-auto" />
                    <h1
                        class="mt-8 text-wrap text-4xl md:text-5xl font-semibold text-title xl:text-5xl xl:[line-height:1.125]">
                        Sistem Agregasi Data <br class="hidden sm:block" /> Karanganyar</h1>
                    <p class="text-wrap mx-auto mt-8 max-w-2xl text-lg hidden sm:block text-body">SIGRA
                        adalah aplikasi pendataan yang dibuat oleh diskominfo Karanganyar.</p>
                    <div class="mt-8 flex flex-col items-center justify-center gap-4">
                        @guest
                            <div class="">
                                <x-primary-link href="/login" class="">
                                    ...
                                    <span class="text-nowrap btn-label">Login</span>
                                </x-primary-link>
                            </div>
                        @endguest
                        ...
                        <button class="hidden btn variant-ghost sz-lg">
                            ...
                            <svg class="-mr-1" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                ...
                                <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                    strokeWidth="4" d="m19 12l12 12l-12 12" />
                            </svg>
                        </button>
                    </div>
                </div>
